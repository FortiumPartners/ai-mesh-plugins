...
**Features**:
- State persistence (~/.ai-mesh-pane-viewer/panes.json)
...
**Configuration**:
- Location: `~/.ai-mesh-pane-viewer/config.json`
...
3. **State Management**: Pane state persists across sessions in ~/.ai-mesh-pane-viewer/panes.json
